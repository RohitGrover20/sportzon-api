...
const carrerRouter = require("./careers/Router");
...
const landingJobRouter = require("./Landing/Routers/Career");
...
app.use("/landing/jobs" , landingJobRouter);
app.listen("9000", () => {
