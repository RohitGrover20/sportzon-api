...
const bookingSchema = mongoose.Schema({
    ...
    court: { type: Array, required: () => { this.bookingType == "arena" ? true : false }, default: [] },
    ...
    eventStatus: { type: String, required: () => { this.bookingType == "event" ? true : false }, eval: ["completed", "cancelled", "upcoming", "unsuccessful", "unavailable"], default: "unavailable" },
